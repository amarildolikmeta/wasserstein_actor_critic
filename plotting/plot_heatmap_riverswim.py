...
## path
seed = 0
base_dir = './data/riverswim/25/gn001/04'
...
for itr_i, itr in enumerate(itrs):
	...
	if vmax_std >= 0:
		JG2 = sns.heatmap(data=data_heatmap, xticklabels = 2, yticklabels = 8, vmin=0, vmax=vmax_std, cmap="jet_r", ax=ax[1,0])
	else:
		JG2 = sns.heatmap(data=data_heatmap, xticklabels = 2, yticklabels = 8, cmap="jet_r", ax=ax[1,0])
	JG3 = sns.heatmap(data=mean_heatmap, xticklabels = 2, yticklabels = 8, vmin=0, vmax=70, cmap="jet_r", ax=ax[0,0])
	JG4 = sns.heatmap(data=histog, xticklabels = 2, yticklabels = 8, cmap="jet_r", ax=ax[0,1])
	if particle:
		JG5 = sns.heatmap(data=range_heatmap, xticklabels = 2, yticklabels = 8, cmap="jet_r", ax=ax[1,1])
	else:
		JG5 = sns.heatmap(data=cum_histo, xticklabels = 2, yticklabels = 8, cmap="jet_r", ax=ax[1,1])
	...
	if particle:
		...
		JG5.set_xticklabels(np.arange(0,25))
